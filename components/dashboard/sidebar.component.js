    ...
    return (
        <div className={`transition-all duration-500 ${drawerOpen ? 'pl-12' : ''}`}>
            ...
            <label
                ...
                className={`fixed initial top-0 left-0 inline-block p-3 transition-all duration-500 bg-blue-300 z-40 rounded-lg ${drawerOpen ? 'rotate-180  pt-5 pb-5 ml-[1.19px]' : ''}`}
            >
